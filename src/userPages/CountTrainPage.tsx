...
const EXERCISES = [
  ...
  {
    id: 'curl', name: 'Bicep Curl', emoji: '💪', color: '#00e5ff', desc: 'Fixed elbows • Lift slowly • Balance sides', calories: 0.16, camDir: 'front',  upperBodyOnly: true, camAngle: 'Direct Front — 1.5 Meters', jointsLeft: [11, 13, 15], jointsRight: [12, 14, 16], upAngle: 50, downAngle: 150, countOn: 'up',
    formChecks: [], feedback: ['Elbow fixed ✓', 'Full range ✓', 'Lower slowly ↓'], voiceRep: ['Lift higher', 'Good job', 'Excellent', 'Great form']
  },
  {
    id: 'lunge', name: 'Lunge', emoji: '🏃‍♂️', color: '#00d68f', desc: 'Knee behind toe • Straight back', calories: 0.26, camDir: 'side', bilateral: false, lungeMode: true, camAngle: 'Side 90° — 2.5 Meters', jointsLeft: [23, 25, 27], jointsRight: [24, 26, 28], upAngle: 170, downAngle: 88, countOn: 'down',
